...
public class ContainerHelper {
	...
	public void creatBlocks() {
		...
		this.putStackInSlot(38, new ItemStack(Items.END_STONE));
	...
	public void creatSwords() {
		
		this.clearSecondPart();
		this.putStackInSlot(37, this.tradeHelper.enchantedStick());
		this.putStackInSlot(38, this.tradeHelper.enchantedGoldSword1());
		this.putStackInSlot(39, this.tradeHelper.enchantedGoldSword2());
		this.putStackInSlot(40, this.tradeHelper.enchantedIronSword1());
		this.putStackInSlot(41, this.tradeHelper.enchantedIronSword2());
		this.putStackInSlot(43, this.tradeHelper.enchantedShield());
		
		this.putStackInSlot(46, new ItemStack(Items.BRICK, 8));
		this.putStackInSlot(47, new ItemStack(Items.IRON_INGOT, 1));
		this.putStackInSlot(48, new ItemStack(Items.IRON_INGOT, 3));
		this.putStackInSlot(49, new ItemStack(Items.GOLD_INGOT, 5));
		this.putStackInSlot(46, new ItemStack(Items.GOLD_INGOT, 9));
		this.putStackInSlot(48, new ItemStack(Items.GOLD_INGOT, 1));
		this.fillSecondPart();
	...
	public void creatArmor() {
		...
		this.clearSecondPart();
		this.putStackInSlot(27, this.tradeHelper.enchantedArmor(Items.LEATHER_HELMET));
		this.putStackInSlot(36, this.tradeHelper.enchantedArmor(Items.LEATHER_LEGGINGS));
		this.putStackInSlot(39, this.tradeHelper.enchantedArmor(Items.LEATHER_BOOTS));
		this.putStackInSlot(29, this.tradeHelper.enchantedArmor(Items.CHAINMAIL_HELMET));
		this.putStackInSlot(38, this.tradeHelper.enchantedArmor(Items.CHAINMAIL_LEGGINGS));
		this.putStackInSlot(47, this.tradeHelper.enchantedArmor(Items.CHAINMAIL_BOOTS));
		...
		this.putStackInSlot(45, new ItemStack(Items.BRICK, 1));
		this.putStackInSlot(30, new ItemStack(Items.IRON_INGOT, 1));
		this.putStackInSlot(39, new ItemStack(Items.IRON_INGOT, 1));
		...
		this.putStackInSlot(53, new ItemStack(Items.GOLD_INGOT, 3));
		this.fillSecondPart();
	...
	public void creatPotions() {
		...
		this.putStackInSlot(41, this.tradeHelper.potionInvisibility());
		...
		this.putStackInSlot(46, new ItemStack(Items.IRON_INGOT, 32));
		this.putStackInSlot(47, new ItemStack(Items.GOLD_INGOT, 8));
		this.putStackInSlot(48, new ItemStack(Items.GOLD_INGOT, 4));
		this.fillSecondPart();
	...
	public void creatMisc() {
		...
		this.putStackInSlot(46, new ItemStack(Items.BRICK, 3));
		this.putStackInSlot(47, new ItemStack(Items.BRICK, 5));
		this.putStackInSlot(48, new ItemStack(Items.IRON_INGOT, 7));
		this.putStackInSlot(49, new ItemStack(Items.GOLD_INGOT, 7));
		this.putStackInSlot(46, new ItemStack(Items.GOLD_INGOT, 32));
		this.putStackInSlot(47, new ItemStack(Items.IRON_INGOT, 8));
		this.putStackInSlot(48, new ItemStack(Items.GOLD_INGOT, 4));
		this.fillSecondPart();
