...
public class TeamScreen extends ContainerScreen<TeamContainer>{
	
	private static final ResourceLocation CHEST_GUI_TEXTURE = new ResourceLocation("textures/gui/container/generic_54.png");
	private final int inventoryRows;
	
	public TeamScreen(TeamContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
